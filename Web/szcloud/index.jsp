...
<body>
	...
	<div id="news" class="news">注：双击手机号即可进行修改</div>
	 <!-- <div class="news">注：小助手中可以找回被修改的手机号</div> -->
	 <div class="litter_helper"><a style="color:blue;" href="<%=webRoot%>/helper/helperIndex.jsp" target="_blank">小助手</a></div>
	    <!-- 查询框开始 -->
		...
		<!-- 结果展示列表开始 -->
		<div id="resultList" class="result_list_merge">
			<table class="table table-hover">
				...
				<tr ng-repeat="userVO in lstUserVO">
					...
					<td>{{userVO.roles}}</td>
					<td>{{userVO.groupVO.groupName}}</td>
				</tr>
			</table>
			<div>
				<nav>
		...
		<%-- <div class="statistics_info">
		    <span>当前在线人数：<span style="color: blue;"><%=OnLineCounter.getOnLineNum() %></span></span>
...
<script src="<%=webRoot%>/js/szcloud/wl.js?ver=3"></script>
